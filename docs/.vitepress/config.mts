          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  text: "快速上手",
                  link: "/uni-colorful/zh/guide/quickstart.html",
                },
                {
                  text: "目录结构",
                  link: "/uni-colorful/zh/guide/directory.html",
                },
                {
                  text: "开发工具",
                  link: "/uni-colorful/zh/guide/devtools.html",
                },
                {
                  text: "注意事项",
                  link: "/uni-colorful/zh/guide/feature.html",
                },
                {
                  text: "更新日志",
                  link: "/uni-colorful/zh/guide/changelog.html",
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "Layout - 布局",
                  link: "/uni-colorful/zh/components/layout.html",
                },
                {
                  text: "Button - 按钮",
                  link: "/uni-colorful/zh/components/button.html",
                },
                {
                  text: "Loader - 加载图标",
                  link: "/uni-colorful/zh/components/loader.html",
                },
                {
                  text: "Loading - 加载框",
                  link: "/uni-colorful/zh/components/loading.html",
                },
                {
                  text: "Table - 表格",
                  link: "/uni-colorful/zh/components/table.html",
                },
                {
                  text: "Toast - 提示",
                  link: "/uni-colorful/zh/components/toast.html",
                },
                {
                  text: "WebView - 网页视图",
                  link: "/uni-colorful/zh/components/webview.html",
                },
                {
                  text: "Updater - 应用更新管理",
                  link: "/uni-colorful/zh/components/updater.html",
                },
                {
                  text: "Apis - 服务器选择",
                  link: "/uni-colorful/zh/components/apis.html",
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "Checker - 表单校验",
                  link: "/uni-colorful/zh/js/checker.html",
                },
                {
                  text: "Http - 网络请求",
                  link: "/uni-colorful/zh/js/http.html",
                },
                {
                  text: "Optimize - 优化类",
                  link: "/uni-colorful/zh/js/optimize.html",
                },
                {
                  text: "Pager - 分页",
                  link: "/uni-colorful/zh/js/pager.html",
                },
                { text: "Push - 推送", link: "/uni-colorful/zh/js/push.html" },
                {
                  text: "Plus - 真机类",
                  link: "/uni-colorful/zh/js/plus.html",
                },
                {
                  text: "Store - 状态管理",
                  link: "/uni-colorful/zh/js/store.html",
                },
